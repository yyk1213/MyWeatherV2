package com.example.yeon1213.myweather_v2.data.Weather.FineDust;
...
public class FineDust {
    @SerializedName("list")
    @Expose
    private java.util.List<com.example.yeon1213.myweather_v2.data.Weather.FineDust.List> list = null;
    @SerializedName("parm")
    @Expose
    private Parm parm;
    ...
    public java.util.List<com.example.yeon1213.myweather_v2.data.Weather.FineDust.List> getList() {
        return list;
    }

    public void setList(java.util.List<com.example.yeon1213.myweather_v2.data.Weather.FineDust.List> list) {
        this.list = list;
    }
